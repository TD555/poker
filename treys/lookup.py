...
class LookupTable:
    ...
    * 7-5-4-3-2 unsuited (worst hand possible)  => 7462
    ...
    def __init__(self) -> None:
        ...
        """
        # create dictionaries
        self.flush_lookup: dict = {}
        self.unsuited_lookup: dict = {}
    ...
    def straight_and_highcards(self, straights: Sequence, highcards: Sequence) -> None:
        """
    ...
    def write_table_to_disk(self, table: dict, filepath: str) -> None:
        """
    ...
    def get_lexographically_next_bit_sequence(self, bits: int) -> Iterator:
        """
        Bit hack from here:
