...
class Card:
    ...
    CHAR_RANK_TO_INT_RANK: dict = dict(zip(list(STR_RANKS), INT_RANKS))
    ...
    @staticmethod
    def hand_to_binary(card_strs: Sequence) -> list:
        """
    ...
    @staticmethod
    def prime_product_from_hand(card_ints: Sequence) -> int:
        """
    ...
    @staticmethod
    def ints_to_pretty_str(card_ints: Sequence) -> str:
        """
        Expects a list of cards in integer form.
        """
        output = " "
    ...
    @staticmethod
    def print_pretty_cards(card_ints: Sequence) -> None:
        """
        Expects a list of cards in integer form.
        """
